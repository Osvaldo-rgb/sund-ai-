...
# Imports diretos (mais seguro que __init__.py)
...
# CORS - Configuração forte para funcionar com localhost + Railway
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],           # Temporariamente aberto (funciona com localhost)
